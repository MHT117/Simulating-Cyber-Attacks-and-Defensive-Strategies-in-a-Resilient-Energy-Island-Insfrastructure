...
for ($r=1; $r -le $Repeats; $r++) {
  foreach ($cfg in $all) {
    .\run_one.ps1 -Scenario $cfg.Scenario -Condition $cfg.Condition -Users $cfg.Users -SpawnRate $cfg.SpawnRate -Duration $cfg.Duration -Host $Host -RunsDir $RunsDir -Repeat $r
